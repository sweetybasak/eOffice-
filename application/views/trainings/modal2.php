...
<div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                ...
                <h4 class="modal-title  w-100 text-center">Directorates</h4>
                   ...
                   <table class="table table-striped table-hover table-bordered" id="my-table1">
                       ...
                       <?php if(isset($part) && is_array($part) && count($part)): $i=1;
                           ...
                           <tr>
                               ...
                               <td><?php  echo '<a data-dismiss="modal" data-toggle="modal" data-target="#participants1" name="participants" onclick="javascript:load_participants('.$data['id'].','.$data['dept'].');">'.$data['users'].'</a>'; ?></td>
                           </tr>
                           <?php }  ?>
                       <?php endif; ?>
                       </tbody>
