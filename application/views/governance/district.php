        ...
        <section id="contact">
            <div class="container-fluid">
                <header class="section-header">
                    <h3>Details of the Districts</h3>
                </header>
                <div class="row">
                        ...
                        <div class="card text-blank border-1">
                            <div class="card-body">
                                <div class="card-title text-center">
                                    <h4><i class="fa fa-university"></i> Details of Districts</h4>
                                </div>
                            <div class="card-text">
                                <table class="display table table-bordered table-striped table-hover" id="my-table" style="width:100%">
