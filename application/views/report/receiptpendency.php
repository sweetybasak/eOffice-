...
<title>Receipt Pendency Report</title>
        ...
        <section id="about">
            <div class="container">
                <header class="section-header">
                    <h3>Details of the Receipt Pendency Report</h3>
                </header>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                    <div class="form-group col-sm-4 text-center">
                                                        <input type="submit" class="btn btn-block btn-primary" id="btn1" value="Submit">
                                                    </div>
                                                    <div class="form-group col-sm-4 text-center">
                                                        <button type="submit" class="btn btn-block btn-danger" name="reset1">Reset</button>
                                                    </div>
                                                </div>
...
<br>
                        ...
                        <div class="card-body">
                            ...
                            <table class="display table table-bordered table-striped table-hover" id="table1" style="width:100%">
...
<br>
                <div class="col">
                        <div class="offset-sm-2 col-sm-6">
                            <div class="card text-white border-warning border-1 bg-dark">
                                <div class="card-body">
                                    <div class="card-title">
                                        <h5><b>Filter</b></h5>
                                    </div>
                                    ...
                                    <form method="post" class="form-horizontal"> 
                                        <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                    <div class="form-group col-sm-4 text-center">
                                                        <input type="submit" class="btn btn-block btn-primary" id="btn2" value="Submit">
                                                    </div>
                                                    <div class="form-group col-sm-4 text-center">
...
<br>
                        <div class="card border-info text-blank border-1">
                        <div class="card-body">
                            <div class="card-title text-center">
                                <h4><i class="fa fa-search"></i>
                                Search Results</h4>
                            ...
                            <table class="display table table-bordered table-striped table-hover" id="table2" style="width:100%">
                                <thead class="bg-primary text-center">
                                    <tr>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" class="form-horizontal"> 
                                        <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                    <div class="form-group col-sm-4 text-center">
                                                        <input type="submit" class="btn btn-block btn-primary" id="btn3" value="Submit">
                                                    </div>
                                                    <div class="form-group col-sm-4 text-center">
                                                        <button type="submit" class="btn btn-block btn-reset" name="btn-reset2">Reset</button>
                                                    </div>
                                                </div>
...
<br>
                        <div class="card text-blank border-info border-1">
                        <div class="card-body">
                            <div class="card-title text-center">
                                <h4><i class="fa fa-search"></i>
                                Search Results</h4>
                            ...
                            <table class="display table table-bordered table-striped table-hover" id="table3" style="width:100%">
                                <thead class="bg-primary text-center">
                                    <tr>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" class="form-horizontal"> 
                                        <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                    <div class="form-group col-sm-4 text-center">
                                                        <input type="submit" class="btn btn-block btn-primary" id="btn4" value="Submit">
                                                    </div>
                                                    <div class="form-group col-sm-4 text-center">
                                                        <button type="submit" class="btn btn-block btn-reset" name="btn-reset3">Reset</button>
                                                    </div>
                                                </div>
...
<br>
                        ...
                        <div class="card-body">
                            ...
                            <table class="display table table-bordered table-striped table-hover" id="table4" style="width:100%">
                                <thead class="bg-primary text-center">
                                    <tr>
