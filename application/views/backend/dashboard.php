...
<div class="carousel-inner">
    <div class="carousel-item active">
        <img src="<?php echo base_url();?>assets/img/big/img1.jpg" alt="First Slide" width="1500" height="350">
    </div>
    <div class="carousel-item">
        <img src="<?php echo base_url();?>assets/img/big/img2.jpg" alt="Second Slide" width="1500" height="350">
    </div>
    <div class="carousel-item">
        <img src="<?php echo base_url();?>assets/img/big/img3.jpg" alt="Third Slide" width="1500" height="350">
    </div>
</div>
