            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal" method="post">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                               <select name="directorate" class="form-control"  required>
                                    <option value="0">No Selected</option>
                                    <?php foreach($directorate as $value ): ?>
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-4">SP Office</label>
                            <div class="col-md-8">
                               <select name="spoffice" class="form-control"  required>
                                    <option value="0">No Selected</option>
                                    <?php foreach($spoffice as $value ): ?>
                                    <option value="<?php echo $value->id ?>"><?php echo $value->name ?></option>
                                    <?php endforeach; ?>
                               </select>
                                <span class="help-block"></span>
...
$(document).ready(function() {
    ...
    otable = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": " <?php echo site_url('api/emdoverall1')?>",
            "type": "POST",
            "dataType": "JSON"
    ...
    stable = $('#my-table2').DataTable({ 
        ...
        // Load data for the table's content from an Ajax source
        "ajax": {
            "url": " <?php echo site_url('api/emdDistrict')?>",
            "type": "POST",
            "dataType": "JSON"
    ...
    atable = $('#my-table3').DataTable({ 
        ...
        // Load data for the table's content from an Ajax source
        "ajax": {
            "url": " <?php echo site_url('api/emdSPOffice')?>",
            "type": "POST",
            "dataType": "JSON"
...
function edit_programme(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('api/emd_edit1/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('api/add_emd1')?>";
    } else {
        url = "<?php echo site_url('api/update_emd1')?>";
    }
