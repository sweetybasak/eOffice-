        ...
        <div class="row">
            <div class="col-12">
               ...
               <div class="alert alert-success" id="successmessage"></div>
                    <button class="btn btn-success" onclick="add_course()"><i class="fas fa-plus"></i> Add Nodal Officer</button>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-dark">
                    ...
                    <button class="btn btn-success" onclick="add_master()"><i class="fas fa-plus"></i> Add Master Trainers</button>
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                    ...
                                    <select name="directorate" class="form-control" id="directorate1">
                                        <option value="0">No Selected</option>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-dark">
                    ...
                    <button class="btn btn-success" onclick="add_emd()"><i class="fas fa-plus"></i> Add EMD Managers</button>
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                    ...
                                    <select name="dept" class="form-control" id="dept2">
                                        <option value="">No Selected</option>
                                        <?php foreach($department as $d):?>
                                        <option value="<?php echo $d->id ?>"><?php echo $d->dname ?></option>
                                        <?php endforeach; ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                    ...
                                    <select name="directorate" class="form-control" id="directorate2">
                                        <option value="0">No Selected</option>
