...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">SP Office</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Extras</a></li>
              <li class="breadcrumb-item active">SP Office</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title w-100 text-center">Details of SP Offices</h3>
                   ...
                   <div class="alert alert-success" id="successmessage"></div>
                    <button class="btn btn-success" onclick="add_spoffice()"><i class="fas fa-plus"></i> Add SP Office</button>
        <button class="btn btn-default" onclick="reload_table_spoffice()"><i class="glyphicon glyphicon-refresh"></i> Reload</button>
        <br />
        <br />
        
                        <table class="table table-bordered table-hover table-striped" id="table_spoffice" style="width:100%; ">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group row">
                            <label class="control-label col-md-4">SP Office Name</label>
                            <div class="col-md-8">
                                <input name="name" placeholder="SP Office Name" class="form-control" type="text" required>
            ...
            <div class="modal-footer">
                <button type="button" id="btnSave" onclick="save_spoffice()" class="btn btn-primary">Save</button>
