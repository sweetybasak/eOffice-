            ...
            <div class="col-12">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title">Details of Designations</h3>
                    ...
                    <button class="btn btn-success" onclick="add_designation()"><i class="fas fa-plus"></i> Add Designation</button>
        <button class="btn btn-default" onclick="reload_table_designation()"><i class="glyphicon glyphicon-refresh"></i> Reload</button>
        <br />
        <br />
        
                        <table class="table table-bordered table-hover table-striped" id="table_designation" style="width:100%; ">
                            <thead class="text-center bg-primary">
                                <tr>
                                        <th>#</th>
                                        <th>Name of the Designation</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title w-100 text-center">Designation Form</h3>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input name="name" placeholder="Designation Name" class="form-control" type="text" required>
            ...
            <div class="modal-footer">
                <button type="button" id="btnSave" onclick="save_designation()" class="btn btn-primary">Save</button>
