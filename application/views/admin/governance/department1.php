            ...
            <div class="col-12">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title w-100 text-center">Details of Departments</h3>
                  ...
                  <div class="alert alert-success" id="successmessage"></div>
                    ...
                    <button class="btn btn-success" onclick="add_course()"><i class="fas fa-plus"></i> Add Department</button>
        <button class="btn btn-default" onclick="reload_table_department()"><i class="glyphicon glyphicon-refresh"></i> Reload</button>
        <br />
        <br />
        
                        <table class="table table-bordered table-hover table-striped" id="table_department" style="width: 100%">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title w-100 text-center">Department Form</h3>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input name="dname" placeholder="Department Name" class="form-control" type="text" required>
