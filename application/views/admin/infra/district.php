...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Infra Assessment of Districts</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title w-100 text-center"> <i class="fas fa-print"></i> Details of Infra Assessments of Districts</h3>
    ...
    <div class="row">
        ...
        <?php $district = $this->adminInfra_model->getDistrict();?>
            <form action="<?php echo base_url('AdminInfra/import2'); ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group row">
                            <label class="control-label col-md-3">Select District</label>
                            <div class="col-sm-4">
        ...
        <br />
                        ...
                        <table class="table table-bordered table-hover table-striped" id="table_district" style="width:20%; ">
