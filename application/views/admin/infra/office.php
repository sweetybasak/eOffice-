...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">InfraAssessments</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active"><a href="#">Infra Assessment</a></li>
            ...
            <div class="col-12">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title w-100 text-center ">Details of Infra Assessments</h3>
    ...
    <div class="row">
        ...
        <div class="col-md-12 head">
            <div class="float-left">
                ...
                <button class="btn btn-default" onclick="reload_table_overall()"><i class="glyphicon glyphicon-refresh"></i> Reload</button>
            </div>
        </div>
        ...
        <div class="col-md-12" id="importFrm" style="display: none;">
            ...
            <form action="<?php echo base_url('AdminInfra/import5'); ?>" method="post" enctype="multipart/form-data">
        ...
        <br/>
                        ...
                        <table class="table table-bordered table-hover table-striped" id="table_overall" style="width:20%; ">
