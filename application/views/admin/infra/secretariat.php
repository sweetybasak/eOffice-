...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Secretariat Departments</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title w-100 text-center ">Details of Infra Assessments of  Secretariat Departments</h3>
    ...
    <?php } ?>
        ...
        <?php $dept = $this->adminInfra_model->getDepartment();?>
            <form action="<?php echo base_url('AdminInfra/import1'); ?>" method="post" enctype="multipart/form-data">
            <?php    if($this->session->userdata('role') === 'Super Admin') {?>
        ...
        <br/>
                        ...
                        <table class="table table-bordered table-hover table-striped" id="table" style="width:20%; ">
